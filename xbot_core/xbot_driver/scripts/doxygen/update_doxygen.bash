...
WORKDIR=/tmp/xbot_driver_doxygen
while [ -d $WORKDIR ]; do
  WORKDIR=/tmp/xbot_driver_doxygen_$RANDOM
done
mkdir -p $WORKDIR
...
# Clone xbot repository into temporal working directory
cd $WORKDIR
git clone https://github.com/yujinrobot/xbot_core
git clone https://github.com/yujinrobot/xbot
